...
class YouTubePlayer:
    ...
    def search_and_play(query):
        ...
        if response['items']:
            random_video = random.choice(response['items'])  # Seleciona aleatoriamente um vídeo da lista de resultados
    ...
    def play_video(video_url):
        ...
        YouTubePlayer.player.audio_set_volume(50)  # Set volume to 50%
...
class RecognizeSpeech:
    ...
    @staticmethod
    def responde_em_voz(texto, volume=1.0):  # Volume do resultado configurado para 100%
        engine = pyttsx3.init()
    ...
    def responde(texto):
        ...
        if "harry oi" in texto:
            ...
            parar_leitura = False
            news_api_key = 'f4c479e4cf284c909b1a460572a6a7f5'
    ...
    def responde_com_musica(query):
        ...
        # Definir o volume da música para 50%
